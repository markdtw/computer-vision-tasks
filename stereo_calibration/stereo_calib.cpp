...
static void StereoCalib (const vector<string>& imagelist, Size boardSize, bool displayCorners=false,
...
{
    // first, parse the command by OpenCV command line parser
    Size boardSize;
    string imagelistfn;
    bool showRectified;
    ...
    // second, read in the image list for camera calibration
